...
export default function BecomePartnerPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const res = await fetch("/api/contact", {
      ...
      body: JSON.stringify({ ...body, context: "become-partner" }),
    });
    ...
    <main className="min-h-screen flex flex-col bg-gradient-to-b from-slate-50 via-gray-50 to-slate-100">
      ...
      <section className="px-6 pt-12 pb-6 text-center">
        <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight">
          Become a MedPACT Partner
        </h1>
        <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
          Share your information and how you would like to collaborate with
          MedPACT—whether as a strategic, technology, data, or distribution
          partner.
        </p>
      </section>
        ...
        {sent ? (
          <div className="rounded-2xl border border-green-200 bg-green-50 p-6 text-center">
            <h2 className="text-lg font-semibold">
              Thank you for your interest in partnering with MedPACT.
            </h2>
